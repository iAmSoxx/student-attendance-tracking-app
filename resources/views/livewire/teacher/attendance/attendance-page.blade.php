                                        ...
                                        <tr :key="{{ $student->id }}">
                                            <td class="h-px w-auto whitespace-nowrap">
                                                <div class="px-6 py-2">
                                                    ...
                                                    {{-- <span
                                                        class="text-xs text-gray-500 dark:text-neutral-500">(23.16%)</span> --}}
                                                </div>
                                            </td>
                                            @foreach (range(1, $daysInMonth) as $day)
                                                <td class="h-px w-auto whitespace-nowrap">
                                                    <div wire:change="updateAttendance({{ $student->id }}, {{ $day }}, $event.target.value)"
                                                        class="px-6 py-2">
                                                        <select class="dark:bg-neutral-900">
