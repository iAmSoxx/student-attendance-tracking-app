    ...
    <div class="flex items-center gap-x-2">
        ...
        @if($tooltip)
            <div class="relative group">
                <svg class="shrink-0 size-4 text-gray-500 dark:text-neutral-500 cursor-pointer"
                ...
                <span
                    class="absolute left-1/2 -translate-x-1/2 mt-1 opacity-0 group-hover:opacity-100 transition-opacity bg-gray-900 text-white text-xs font-medium py-1 px-2 rounded-md shadow-2xs dark:bg-neutral-700">
                    {{ $tooltip }}
                </span>
            </div>
        @endif
